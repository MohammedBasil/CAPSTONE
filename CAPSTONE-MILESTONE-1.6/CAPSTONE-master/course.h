...
{
    public:
        Course(const ResCode code, const string name, const Degree degree, const ID professor1ID, const ID professor2ID, const unsigned int credits, const Status status = Status::Created)
